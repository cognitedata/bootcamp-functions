                ...
                [
                    {
                        ...
                        "datapoints": get_payload(lambda x, off=bad_items[window_size:]: off[x], lookback_minutes, now),
                    }
                ]
            )
                ...
                [
                    {
                        ...
                        "datapoints": get_payload(lambda x, q=quality[window_size:]: q[x], lookback_minutes, now),
                    }
                ]
            )
